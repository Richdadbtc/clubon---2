...
class HomeScreenMen6 extends StatelessWidget {
  @override
                        ...
                        children: [
                          Container(
                            ...
                            child: SizedBox(
                              ...
                              child: SvgPicture.asset(
                                'assets/vectors/cellular_connection_50_x2.svg',
                              ),
                            ),
                          ),
                          Container(
                          ...
                          Container(
                            ...
                            child: SizedBox(
                              ...
                              height: 11.3,
                              child: SvgPicture.asset(
                                'assets/vectors/battery_97_x2.svg',
                              ),
                            ),
                          ),
                        ],
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            margin: EdgeInsets.fromLTRB(17.2, 0, 17.2, 163),
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.start,
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Container(
                                    ...
                                    child: Container(
                                      padding: EdgeInsets.fromLTRB(20, 28, 0, 28),
                                      child: Row(
                                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          SizedBox(
                                            ...
                                            height: 24,
                                            child: SvgPicture.asset(
                                              'assets/vectors/alert_circle_x2.svg',
                                            ),
                                          ),
                                          Container(
                                            margin: EdgeInsets.fromLTRB(0, 3.5, 0, 3.5),
                                            child: Text(
                                              'An error message that appears here',
                                              style: GoogleFonts.getFont(
                                                'Inter',
