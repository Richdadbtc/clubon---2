...
class NigerianAccount1 extends StatelessWidget {
  @override
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            ...
                            child: SizedBox(
                              ...
                              child: SvgPicture.asset(
                                'assets/vectors/cellular_connection_83_x2.svg',
                              ),
                            ),
                          ),
                          Container(
                          ...
                          SizedBox(
                            ...
                            height: 11.3,
                            child: SvgPicture.asset(
                              'assets/vectors/battery_108_x2.svg',
                            ),
                          ),
                        ],
                      ),
                      ...
                      children: [
                        Container(
                          ...
                          child: SizedBox(
                            ...
                            height: 12,
                            child: SvgPicture.asset(
                              'assets/vectors/vector_781_x2.svg',
                            ),
                          ),
                        ),
                        Text(
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          child: Container(
                                            width: 28,
                                            height: 28,
                                            padding: EdgeInsets.fromLTRB(9, 10, 8.8, 11),
                                            child: SizedBox(
                                              width: 10.2,
                                              height: 7,
                                              child: SvgPicture.asset(
